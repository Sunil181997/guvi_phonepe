...
icon = Image.open(r"\Users\LENOVO\Desktop\jupyter1\pulse-master\PhonePe_Logo.jpg")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# guvi phone pay pulse project"""})
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\LENOVO\Desktop\jupyter1\Statenames.csv')
            df1.State = df2
